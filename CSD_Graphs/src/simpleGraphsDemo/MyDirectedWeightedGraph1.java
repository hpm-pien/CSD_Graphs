...
public class MyDirectedWeightedGraph1 extends AbstractGraph{
    ...
    public boolean loadGraph() {
        ...
        try {
            ...
            String line;
            //read 1st line, vertices will be added
            line = bf.readLine();
            stk1 = new StringTokenizer(line, " "); // a b c d e f g h i j
            //add vertices
            while (stk1.hasMoreElements()){
                String vKey = stk1.nextToken(); //get a vertex key
                this.addVertex(vKey);
            }
            //add edges
            while ((line = bf.readLine())!=null && line.length()>0){
                stk1 = new StringTokenizer(line, " "); // a (e,1) (h,10)
                String srcKey = stk1.nextToken(); //a
                while (stk1.hasMoreElements()) {
                    String part = stk1.nextToken();
                    stk2 = new StringTokenizer(part, "(), "); // (e,1)
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Shortest paths, Dijkstra algothm:");
        DJ_SP_Result result = processor.createDJShortestResult("a");
        if (result == null) {
